...
enum IrizTheme {
    ...
    static let listening = Color(red: 0.12, green: 0.68, blue: 0.50)
    static let observingAndListening = Color(red: 0.30, green: 0.36, blue: 0.86)
    static let privateContext = Color(red: 0.94, green: 0.25, blue: 0.48)
    static let meeting = Color(red: 0.96, green: 0.77, blue: 0.18)
